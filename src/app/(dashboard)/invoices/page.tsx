                ...
                return (
                  <tr key={invoice.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-slate-600">
                      {invoice.client?.name || <span className="text-slate-300">—</span>}
                    </td>
                    <td className="px-6 py-4 text-sm text-slate-600">
                      {invoice.project?.name || <span className="text-slate-300">—</span>}
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-sm text-slate-600">
                      {invoice.dueDate ? new Date(invoice.dueDate).toLocaleDateString() : <span className="text-slate-300">—</span>}
                    </td>
                    <td className="px-6 py-4">
